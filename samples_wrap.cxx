...
#define SWIGTYPE_p_std__vectorT_std__complexT_float_t_t swig_types[17]
#define SWIGTYPE_p_std__vectorT_std__vectorT_float_t_t swig_types[18]
...
static int _wrap_audio_fft_forward(lua_State* L) {
  ...
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("SoundWave::audio_fft_forward",1,"std::vector< float > &");
...
static int _wrap_audio_fft_inverse(lua_State* L) {
  ...
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("SoundWave::audio_fft_inverse",1,"std::vector< std::complex< float > > &");
...
static int _wrap_audio_convolve(lua_State* L) {
  ...
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("SoundWave::audio_convolve",1,"std::vector< float > &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SoundWave::audio_convolve",2,"size_t");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("SoundWave::audio_convolve",3,"std::vector< float > &");
...
static int _wrap_zeros_float__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("SoundWave::zeros< float >",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("SoundWave::zeros< float >",1,"std::vector< float > &");
...
static int _wrap_zeros_float(lua_State* L) {
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'zeros_float'\n"
    ...
    "    SoundWave::zeros< float >(std::vector< float > &)\n");
  lua_error(L);return 0;
}
...
static int _wrap_ones_float__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("SoundWave::ones< float >",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("SoundWave::ones< float >",1,"std::vector< float > &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("ones_float",1,SWIGTYPE_p_std__vectorT_float_t);
  }
...
static int _wrap_ones_float(lua_State* L) {
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'ones_float'\n"
    ...
    "    SoundWave::ones< float >(std::vector< float > &)\n");
  lua_error(L);return 0;
}
