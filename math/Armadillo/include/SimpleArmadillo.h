...
*/      
        ...
        T    __getitem__(size_t i) { return vector(i); }
        void __setitem__(size_t i, T v) { vector(i) = v; }
        ...
        void println(const std::string & header = "") { vector.print(header); }
...
*/
        ...
        MatrixView<T> __getitem__(size_t row) { return MatrixView<T>(&matrix,row); }
        void __setitem__(size_t col, const Vector<T> & val) { matrix.col(col) = val.vector; }
        void __setitem__(size_t row, const RowVector<T> & val) { matrix.row(row) = val.vector; }
        ...
        void println(const std::string & header = "") { matrix.print(header); }
