...
namespace SoundAlchemy
{
    ...
    {        
        return DSP::lowpassfilter(i,freq,q);     
    }
    template<typename T>
    ...
    {
        return DSP::highpassfilter(i,freq,q);
    }
    template<typename T>
    ...
    {        
        return DSP::bandpassfilter(i,freq,q);        
    }
    template<typename T>
    ...
    {
        return DSP::notchfilter(i,freq,q);        
    }
    template<typename T>
    ...
    {        
        return DSP::allpassfilter(i,freq,q);
    }
    template<typename T>
    ...
    {
        return DSP::peakfilter(i,freq,q,gain);
    }
    template<typename T>
    ...
    {
        return DSP::lowshelffilter(i,freq,q);        
    }
    template<typename T>
...
template<typename T>
    ...
    {
        return DSP::highshelffilter(i,freq,q);
    }
    template<typename T>
    ...
    template<typename T> 
    sample_vector<T> resample(QualityType quality,sample_vector<T> in, T input_rate, T output_rate)
    {        
    ...
    template<typename T>
    sample_vector<T> window(WindowType,size_t s, const T x = -1) {
        return sample_vector<T>(make_window(type,s));
    }
