...
#define SWIGTYPE_p_fftw_complex swig_types[1]
...
#define SWIGTYPE_p_std__vector_iteratorT_double_t swig_types[9]
...
#define SWIG_name      "xcorr"
#define SWIG_init      luaopen_xcorr
#define SWIG_init_user luaopen_xcorr_user

#define SWIG_LUACODE   luaopen_xcorr_luacode
...
static int _wrap_xcorr(lua_State* L) {
  int SWIG_arg = 0;
  fftw_complex *arg1 = (fftw_complex *) 0 ;
  fftw_complex *arg2 = (fftw_complex *) 0 ;
  fftw_complex *arg3 = (fftw_complex *) 0 ;
  int arg4 ;
  
  SWIG_check_num_args("xcorr",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("xcorr",1,"fftw_complex *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("xcorr",2,"fftw_complex *");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("xcorr",3,"fftw_complex *");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("xcorr",4,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_fftw_complex,0))){
    SWIG_fail_ptr("xcorr",1,SWIGTYPE_p_fftw_complex);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_fftw_complex,0))){
    SWIG_fail_ptr("xcorr",2,SWIGTYPE_p_fftw_complex);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_fftw_complex,0))){
    SWIG_fail_ptr("xcorr",3,SWIGTYPE_p_fftw_complex);
  }
  
  arg4 = (int)lua_tonumber(L, 4);
  xcorr(arg1,arg2,arg3,arg4);
