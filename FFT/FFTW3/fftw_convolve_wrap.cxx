...
#define SWIG_name      "fftw_convolve"
#define SWIG_init      luaopen_fftw_convolve
#define SWIG_init_user luaopen_fftw_convolve_user

#define SWIG_LUACODE   luaopen_fftw_convolve_luacode
...
static int _wrap_convolve(lua_State* L) {
  ...
  SWIG_check_num_args("convolve",2,2)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("convolve",1,"vector< float > const &");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("convolve",2,"vector< float > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_vectorT_float_t,0))){
    SWIG_fail_ptr("convolve",1,SWIGTYPE_p_vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_vectorT_float_t,0))){
    SWIG_fail_ptr("convolve",2,SWIGTYPE_p_vectorT_float_t);
  }
  
  result = convolve((vector< float > const &)*arg1,(vector< float > const &)*arg2);
  {
    vector< float > * resultptr = new vector< float >((const vector< float > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_vectorT_float_t,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static int _wrap_fftw_convolve(lua_State* L) {
  int SWIG_arg = 0;
  vector< float > *arg1 = 0 ;
  vector< float > *arg2 = 0 ;
  vector< float > result;
  
  SWIG_check_num_args("fftw_convolve",2,2)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("fftw_convolve",1,"vector< float > &");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("fftw_convolve",2,"vector< float > &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_vectorT_float_t,0))){
    SWIG_fail_ptr("fftw_convolve",1,SWIGTYPE_p_vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_vectorT_float_t,0))){
    SWIG_fail_ptr("fftw_convolve",2,SWIGTYPE_p_vectorT_float_t);
  }
  
  result = fftw_convolve(*arg1,*arg2);
  {
    vector< float > * resultptr = new vector< float >((const vector< float > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_vectorT_float_t,1); SWIG_arg++;
  }
...
static swig_lua_method swig_SwigModule_methods[]= {
    ...
    { "fftw_convolve", _wrap_fftw_convolve},
    {0,0}
};
