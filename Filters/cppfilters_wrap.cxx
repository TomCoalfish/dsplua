...
#define SWIGTYPE_p_Biquad__tp_coeffs swig_types[2]
#define SWIGTYPE_p_FO_APF swig_types[3]
#define SWIGTYPE_p_FO_HPF swig_types[4]
#define SWIGTYPE_p_FO_LPF swig_types[5]
#define SWIGTYPE_p_FO_SHELVING_HIGH swig_types[6]
#define SWIGTYPE_p_FO_SHELVING_LOW swig_types[7]
#define SWIGTYPE_p_SO_APF swig_types[8]
#define SWIGTYPE_p_SO_BPF swig_types[9]
#define SWIGTYPE_p_SO_BSF swig_types[10]
#define SWIGTYPE_p_SO_BUTTERWORTH_BPF swig_types[11]
#define SWIGTYPE_p_SO_BUTTERWORTH_BSF swig_types[12]
#define SWIGTYPE_p_SO_BUTTERWORTH_HPF swig_types[13]
#define SWIGTYPE_p_SO_BUTTERWORTH_LPF swig_types[14]
#define SWIGTYPE_p_SO_HPF swig_types[15]
#define SWIGTYPE_p_SO_LINKWITZ_RILEY_HPF swig_types[16]
#define SWIGTYPE_p_SO_LINKWITZ_RILEY_LPF swig_types[17]
#define SWIGTYPE_p_SO_LPF swig_types[18]
#define SWIGTYPE_p_SO_PARAMETRIC_CQ_BOOST swig_types[19]
#define SWIGTYPE_p_SO_PARAMETRIC_CQ_CUT swig_types[20]
#define SWIGTYPE_p_SO_PARAMETRIC_NCQ swig_types[21]
#define SWIGTYPE_p_coef_size_t swig_types[22]
...
static int _wrap_Biquad_set_offset(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Biquad::set_offset",2,"Biquad::coef_size_t");
...
static int _wrap_Biquad_get_offset(lua_State* L) {
  ...
  result = (Biquad::coef_size_t)(arg1)->get_offset();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_BiquadModified_process(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("BiquadModified::process",2,"Biquad::coef_size_t");
...
static int _wrap_FO_APF_calculate_coeffs__SWIG_0(lua_State* L) {
  ...
  result = (Biquad::tp_coeffs *) &(arg1)->calculate_coeffs(arg2,arg3);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Biquad__tp_coeffs,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_FO_APF_calculate_coeffs__SWIG_1(lua_State* L) {
  ...
  arg2 = (int)lua_tonumber(L, 2);
  result = (Biquad::tp_coeffs *) &(arg1)->calculate_coeffs(arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Biquad__tp_coeffs,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_FO_SHELVING_HIGH_calculate_coeffs(lua_State* L) {
  ...
  result = (Biquad::tp_coeffs *) &(arg1)->calculate_coeffs(arg2,arg3,arg4);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Biquad__tp_coeffs,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_SO_BUTTERWORTH_BSF_calculate_coeffs(lua_State* L) {
  int SWIG_arg = 0;
  SO_BUTTERWORTH_BSF *arg1 = (SO_BUTTERWORTH_BSF *) 0 ;
  float arg2 ;
  int arg3 ;
  int arg4 ;
  Biquad::tp_coeffs *result = 0 ;
  
  SWIG_check_num_args("SO_BUTTERWORTH_BSF::calculate_coeffs",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("SO_BUTTERWORTH_BSF::calculate_coeffs",1,"SO_BUTTERWORTH_BSF *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("SO_BUTTERWORTH_BSF::calculate_coeffs",2,"float");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("SO_BUTTERWORTH_BSF::calculate_coeffs",3,"int");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("SO_BUTTERWORTH_BSF::calculate_coeffs",4,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_SO_BUTTERWORTH_BSF,0))){
    SWIG_fail_ptr("SO_BUTTERWORTH_BSF_calculate_coeffs",1,SWIGTYPE_p_SO_BUTTERWORTH_BSF);
  }
...
static int _wrap_new_SO_BUTTERWORTH_BSF(lua_State* L) {
  int SWIG_arg = 0;
  SO_BUTTERWORTH_BSF *result = 0 ;
  
  SWIG_check_num_args("SO_BUTTERWORTH_BSF::SO_BUTTERWORTH_BSF",0,0)
  result = (SO_BUTTERWORTH_BSF *)new SO_BUTTERWORTH_BSF();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_SO_BUTTERWORTH_BSF,1); SWIG_arg++; 
  return SWIG_arg;
...
SO_BUTTERWORTH_BSF *arg1 = (SO_BUTTERWORTH_BSF *) obj;
delete arg1;
}
...
static int _wrap_SO_PARAMETRIC_CQ_BOOST_calculate_coeffs(lua_State* L) {
  ...
  result = (Biquad::tp_coeffs *) &(arg1)->calculate_coeffs(arg2,arg3,arg4,arg5);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Biquad__tp_coeffs,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_SO_PARAMETRIC_CQ_CUT_calculate_coeffs(lua_State* L) {
  ...
  {
    Biquad::tp_coeffs * resultptr = new Biquad::tp_coeffs((const Biquad::tp_coeffs &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Biquad__tp_coeffs,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static void *_p_SO_BUTTERWORTH_BSFTo_p_Biquad(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Biquad *)  ((SO_BUTTERWORTH_BSF *) x));
}
...
static swig_type_info _swigt__p_Biquad__tp_coeffs = {"_p_Biquad__tp_coeffs", "Biquad::tp_coeffs *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_SO_BUTTERWORTH_BSF = {"_p_SO_BUTTERWORTH_BSF", "SO_BUTTERWORTH_BSF *", 0, 0, (void*)&_wrap_class_SO_BUTTERWORTH_BSF, 0};
...
static swig_type_info _swigt__p_coef_size_t = {"_p_coef_size_t", "coef_size_t *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_Biquad__tp_coeffs[] = {  {&_swigt__p_Biquad__tp_coeffs, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_SO_BUTTERWORTH_BSF[] = {  {&_swigt__p_SO_BUTTERWORTH_BSF, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_coef_size_t[] = {  {&_swigt__p_coef_size_t, 0, 0, 0},{0, 0, 0, 0}};
